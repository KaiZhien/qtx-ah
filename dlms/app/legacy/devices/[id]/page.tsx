      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex gap-2 shrink-0">
          {can(role, ACTIONS.EDIT_DEVICE) && (
            <Link href={`/legacy/devices/${device.id}/edit`}>
            ...
            <div className="border rounded-md p-4 space-y-3">
              ...
              {successor && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <Link href={`/legacy/devices/${successor.id}`} className="font-mono underline hover:no-underline">
              ...
              {predecessor && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <Link href={`/legacy/devices/${predecessor.id}`} className="font-mono underline hover:no-underline">
