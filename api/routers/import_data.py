...
async def import_file(
    ...
    The uploaded file is written to a NamedTemporaryFile (always cleaned up),
    then processed through: load_raw/read_csv -> normalise -> classify ->
    compute_change_scores -> compute_composite -> compute_responders ->
    build_feature_matrix. Max file size: 50 MB.
    """
